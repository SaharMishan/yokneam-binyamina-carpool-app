...
const translations: Translations = {
    he: {
        ...
        error_email_in_use: 'כתובת האימייל כבר נמצאת בשימוש במערכת',
        error_invalid_email: 'כתובת האימייל אינה תקינה',
        error_password_short: 'הסיסמה חייבת להכיל לפחות 6 תווים',
        error_invalid_phone: 'מספר הטלפון אינו תקין',
        error_missing_fields: 'נא למלא את כל שדות החובה',
        error_invalid_credentials: 'פרטי ההתחברות לא תואמים. אם נרשמת עם Google, תוכל להגדיר סיסמה ידנית על ידי לחיצה על "שכחת סיסמה".',
        error_too_many_requests: 'יותר מדי ניסיונות כושלים. החשבון ננעל זמנית.',
        error_account_collision: 'כבר קיים חשבון עם האימייל הזה במערכת (ייתכן שנרשמת עם סיסמה). אנא נסה להתחבר עם אימייל וסיסמה.',
        error_no_phone: 'לא נמצא מספר טלפון ליצירת קשר.',
        error_no_phone_driver: 'לא נמצא מספר טלפון עבור הנהג. אנא שלח לו הודעה בצ׳אט לבקש פרטי קשר.',
        error_no_phone_passenger: 'לא נמצא מספר טלפון עבור הנוסע. מומלץ לשלוח לו הודעה בצ׳אט הנסיעה.',
        ...
        edit_profile: 'לעדכון הפרופיל',
        maybe_later: 'אולי מאוחר יותר',
        error_ios_pwa_google: 'התחברות עם Google בתוך האפליקציה המותקנת באייפון מוגבלת על ידי אפל. מומלץ להתחבר דרך הדפדפן (Safari) או להשתמש באימייל וסיסמה.',
        error_ios_pwa_google_hint: 'שים לב: באייפון מותקן (PWA), התחברות עם Google עלולה להיחסם על ידי אפל. אם נתקלת בבעיה, מומלץ להשתמש באימייל וסיסמה.',
        error_set_password_hint: 'נרשמת עם גוגל? לחץ כאן להגדרת סיסמה ראשונה',
        error_login_required: 'יש להזין אימייל וסיסמה',
        ...
        pickup_modal_btn: 'הצטרף לנסיעה',
        offer_to_join: 'צרף נוסע/ת לנסיעה',
        ...
        request_status_success: 'צורפת לנסיעה',
        request_status_searching: 'ממתין לנסיעה',
        request_status_taken: 'הנוסע צורף לנסיעה אחרת'
    }
};
