                ...
                {isOpen && (
                    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4" onClick={onClose}>
                        ...
                        <motion.div 
                            ...
                            className="bg-white dark:bg-slate-900 w-full max-w-md rounded-[2.5rem] shadow-2xl overflow-hidden border border-white/20 flex flex-col max-h-[80vh] relative z-10" 
                                        ...
                                        {loading ? (
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                {rides.map(ride => {
                                                    ...
                                                    const displayDate = dateObj.toLocaleDateString('he-IL', { day: 'numeric', month: 'numeric' });
