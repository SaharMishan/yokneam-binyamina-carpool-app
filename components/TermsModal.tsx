                ...
                {isOpen && (
                    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4" onClick={onClose}>
                        ...
                        <motion.div 
                            ...
                            className="bg-white dark:bg-slate-900 w-full max-w-md h-[80vh] rounded-[2rem] shadow-2xl overflow-hidden border border-slate-100 dark:border-slate-800 flex flex-col relative z-10" 
